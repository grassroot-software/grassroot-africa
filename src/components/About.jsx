    ...
    <section className='about__Vision'>
        <div className='container about__Vision-container'>
            ...
            <div className='about__section-content'>
                ...
                <p>
                Prisons may seem designed to strip inhabitants of their humanity, but some individuals discover new hope and strength during their incarceration.<br><br>
                ...
                <br><br>The idea behind this scheme is to promote a paradigm shift in their thought processes, equip them with employable skills to 
                enhance their chances of securing jobs after release from prison.<br><br>
